...
export { default as OnlineConsultation } from '../..\\components\\Home\\OnlineConsultation.vue'
export { default as OurDoctors } from '../..\\components\\Home\\OurDoctors.vue'
...
export { default as GeneralContactUs } from '../..\\components\\shared\\GeneralContactUs.vue'
export { default as Header } from '../..\\components\\shared\\Header.vue'
export { default as HomeTitle } from '../..\\components\\shared\\HomeTitle.vue'
...
export const LazyOnlineConsultation = import('../..\\components\\Home\\OnlineConsultation.vue' /* webpackChunkName: "components_Home/OnlineConsultation" */).then(c => c.default || c)
export const LazyOurDoctors = import('../..\\components\\Home\\OurDoctors.vue' /* webpackChunkName: "components_Home/OurDoctors" */).then(c => c.default || c)
...
export const LazyFooter = import('../..\\components\\shared\\Footer.vue' /* webpackChunkName: "components_shared/Footer" */).then(c => c.default || c)
export const LazyGeneralContactUs = import('../..\\components\\shared\\GeneralContactUs.vue' /* webpackChunkName: "components_shared/GeneralContactUs" */).then(c => c.default || c)
export const LazyHeader = import('../..\\components\\shared\\Header.vue' /* webpackChunkName: "components_shared/Header" */).then(c => c.default || c)
export const LazyHomeTitle = import('../..\\components\\shared\\HomeTitle.vue' /* webpackChunkName: "components_shared/HomeTitle" */).then(c => c.default || c)
export const LazyMenu = import('../..\\components\\shared\\Menu.vue' /* webpackChunkName: "components_shared/Menu" */).then(c => c.default || c)
export const LazyTopPhoto = import('../..\\components\\shared\\TopPhoto.vue' /* webpackChunkName: "components_shared/TopPhoto" */).then(c => c.default || c)
